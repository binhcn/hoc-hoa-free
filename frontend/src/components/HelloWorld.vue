<template>
  <div id="app">
    ...
    >
      ...
      <div
        class="w-16 flex justify-center items-center text-gray-600 sm:hidden"
      >
        <button
      ...
      <div class="flex justify-center items-center">
        <button
          ...
          :key="idx"
          class="border rounded-md px-4 py-2 border-yellow-500 text-sm lg:text-lg mr-6"
        >
          {{ cate.title }}
        </button>
      </div>
    ...
    <aside
      class="hidden pt-16 w-60 text-white bg-gray-700 fixed inset-y-0 overflow-x-hidden overflow-y-auto sm:block"
    >
        ...
        >
          ...
          <div class="flex justify-end pr-10">
            <button
              ...
              class="text-xs font-bold px-4 py-2 mr-2 text-gray-50 bg-green-500 rounded-md"
            >
